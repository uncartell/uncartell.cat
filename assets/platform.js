(()=>{
  ...
  const upgradeWords=lang==='ca'?{
    title:'Actualitza el pla per desbloquejar noves funcions',copy:'Tria el pla que encaixa amb el que necessites.',view:'Veure plans',choose:'Actualitza el pla per desbloquejar noves funcions',chooseCopy:'Comença gratis i amplia les eines quan les necessitis.',current:'Pla actual',recommended:'Recomanat',soon:'Properament',basicCopy:'Crea i descarrega sense registrar-te.',premiumCopy:'Desa projectes i edita els teus QR sense tornar-los a imprimir.',ultraCopy:'Personalització avançada i analítiques dels teus QR.',basicFeatures:['10 descàrregues diàries','PDF en totes les eines','Crea codis QR','Destinació del QR no editable'],premiumFeatures:['Tot el que inclou Basic','Desa i gestiona projectes','Descàrregues en PDF i PNG','QR dinàmics','Substitueix la URL conservant el mateix QR'],ultraFeatures:['Tot el que inclou Premium','Descàrregues en PDF, PNG i SVG','Kit de marca i imatges','Analítiques de QR · 7, 30 i 90 dies'],premiumCta:'Activa Premium gratis',ultraCta:'Avisa’m',ultraEmail:'El teu correu',ultraSent:'T’avisarem ✓',close:'Tanca',back:'Torna enrere'
  }:{
