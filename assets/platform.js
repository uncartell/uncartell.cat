(()=>{
  ...
  const upgradeWords=lang==='ca'?{
    title:'Actualitza el pla per utilitzar noves funcions',copy:'Tria el pla que encaixa amb el que necessites.',view:'Veure plans',choose:'Actualitza el pla per utilitzar noves funcions',chooseCopy:'Comença gratis i amplia les eines quan les necessitis.',current:'Pla actual',recommended:'Premium · Més popular',soon:'Properament',basicCopy:'Crea, descarrega i comparteix fàcilment.',premiumCopy:'Tot el que necessites per crear, personalitzar i reutilitzar els teus dissenys.',ultraCopy:'Més control de marca, formats avançats i analítiques.',basicFeatures:['Fins a 10 descàrregues al dia','Descàrrega en PDF','Crea codis QR','Cartells, cartes i taules de preus','Sense registre'],premiumFeatures:['Tot el que inclou Basic','Cartes web per a mòbil','Descàrregues il·limitades','Desa i gestiona projectes','Descàrrega en PDF i PNG','QR dinàmics','Canvia la destinació dels QR quan vulguis','Personalitza els colors'],ultraFeatures:['Tot el que inclou Premium','Projectes il·limitats','QR dinàmics il·limitats','Descàrrega en PDF, PNG i SVG','Elimina o personalitza la marca d’aigua','Afegeix el teu logotip','Kit de marca','Imatges i personalització avançada','Analítiques dels QR','Dades dels últims 7, 30 o 90 dies','Suport prioritari'],premiumCta:'Activa Premium gratis',ultraCta:'Avisa’m',ultraEmail:'El teu correu',ultraSent:'T’avisarem ✓',close:'Tanca',back:'Torna enrere'
  }:{
