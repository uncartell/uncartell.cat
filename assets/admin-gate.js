(()=>{
  ...
  const loadAdmin=()=>{document.querySelector('[data-admin-gate]')?.remove();if(main)main.hidden=false;['/assets/poster-admin.js?v=admin-crud-modal-20260910','/assets/publication-admin.js?v=admin-crud-20260910','/assets/admin-dashboard.js?v=admin-crud-20260910'].forEach(src=>{const script=document.createElement('script');script.src=src;document.body.appendChild(script)})};
