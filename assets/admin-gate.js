(()=>{
  ...
  const loadAdmin=()=>{document.querySelector('[data-admin-gate]')?.remove();if(main)main.hidden=false;['/assets/poster-admin.js?v=11','/assets/publication-admin.js?v=4','/assets/admin-dashboard.js?v=support-session-v2-20260902'].forEach(src=>{const script=document.createElement('script');script.src=src;document.body.appendChild(script)})};
