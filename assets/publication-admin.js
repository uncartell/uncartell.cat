(()=>{
  ...
  host.insertAdjacentHTML('beforeend',`<section class="publication-admin"><header><div><h2>${labels.title}</h2><p>${labels.copy}</p></div><button type="button" data-publication-refresh>${labels.refresh}</button></header><p class="publication-admin-feedback" data-publication-feedback></p><div class="publication-admin-list" data-publication-list></div></section>`);
