(()=>{
  ...
  const labels=es?{
    ...
    title:'Cartes i serveis publicats',copy:'Controla les URL públiques, el propietari, el pla i la vigència.',refresh:'Actualitza',search:'Cerca per títol, URL, ID, usuari o correu',clear:'Neteja',all:'Tots',menu:'Cartes per a mòbil',services:'Serveis',empty:'Encara no hi ha publicacions.',owner:'Usuari',plan:'Pla',expires:'Caduca',updated:'Actualitzat',active:'Activa',disabled:'Bloquejada',expired:'Caducada',remove:'Elimina',confirmRemove:'Confirma eliminació',error:'No s’han pogut carregar les publicacions.'
  };
