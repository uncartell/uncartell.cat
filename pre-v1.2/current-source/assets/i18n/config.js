(function (global) {
  ...
  const LOCALES = Object.freeze({
    ...
    it: Object.freeze({ locale: 'it', languageTag: 'it-IT', brand: 'Uncartello', brandStem: 'uncartello', tld: 'it', domain: 'uncartello.it', email: 'hola@uncartello.it', enabled: true, public: true, indexable: false })
  });
